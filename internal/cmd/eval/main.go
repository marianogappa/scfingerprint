...
// Usage:
//
//	go run ./internal/cmd/eval -csv corpus.csv [-artifact model.json] [-exclusions smurfs.json] [-gates gates.json]
//
...
import (
	...
	"github.com/marianogappa/scfingerprint/internal/eval"
	"github.com/marianogappa/scfingerprint/internal/model"
