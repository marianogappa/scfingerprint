...
var regenerate = flag.Bool("regenerate-dataset", false, "regenerate synthetic seed dataset files under players/ (for testing only; production dataset is built by internal/cmd/seed-dataset)")

// TestRegenerateDataset writes synthetic seed identity files for isolated
// testing. The production dataset is built by internal/cmd/seed-dataset from the real
